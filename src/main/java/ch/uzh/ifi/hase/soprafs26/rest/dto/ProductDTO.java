...
public class ProductDTO {
  ...
  public Boolean getLocalFallback() { return localFallback; }
  ...
  public List<String> getStoreTags() { return storeTags; }
  public void setStoreTags(List<String> storeTags) { this.storeTags = storeTags; }

  public List<String> getPurchasePlaces() { return purchasePlaces; }
  public void setPurchasePlaces(List<String> purchasePlaces) { this.purchasePlaces = purchasePlaces; }
  ...
  public Map<String, Object> getRawProduct() { return rawProduct; }
  public void setRawProduct(Map<String, Object> rawProduct) { this.rawProduct = rawProduct; }
}
