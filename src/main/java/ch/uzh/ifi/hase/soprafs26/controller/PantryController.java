...
public class PantryController {
    ...
    @PostMapping({"/households/{householdId}/pantry/recognize-food", "/households/{householdId}/meal/recognize-food"})
    @ResponseStatus(HttpStatus.OK)
    public MealFoodRecognitionResponseDTO recognizeMealFood(
        ...
        return pantryService.recognizeMealFood(householdId, image, authenticatedUserId);
    }
