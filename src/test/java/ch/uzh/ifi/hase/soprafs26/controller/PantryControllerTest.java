...
class PantryControllerTest {
        ...
        when(pantryService.consumeItem(1L, 10L, 2.0, null, null, false, 99L, null)).thenReturn(result);
        ...
        when(pantryService.consumeItem(1L, 10L, 0.0, null, null, false, 99L, null))
