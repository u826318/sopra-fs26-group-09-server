...
public class ReceiptPantryItemSuggestionDTO {
  ...
  private Boolean readyForBulkAdd;
  ...
  public Boolean getReadyForBulkAdd() {
    return readyForBulkAdd;
  }

  public void setReadyForBulkAdd(Boolean readyForBulkAdd) {
    this.readyForBulkAdd = readyForBulkAdd;
  }
}
